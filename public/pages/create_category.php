            ...
            <section class="form-container">
                ...
                <form method="post" action="">
                    <div class="form-item">
                        ...
                        <input type="text" placeholder="Enter your Category Name" id="categoryName" name="categoryName"
                            required>
                    </div>
                    <div class="form-item">
                        <label for="categoryDescription">Description:</label>
                        <textarea id="categoryDescription" placeholder="Enter a short description!"
                            name="categoryDescription" rows="4" required></textarea>
                        <div id="char-count">
                            <span id="curr">0</span>
